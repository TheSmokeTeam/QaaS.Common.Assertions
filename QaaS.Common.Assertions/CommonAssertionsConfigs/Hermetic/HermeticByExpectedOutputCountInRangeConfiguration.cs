...
[
    Description(
        "Checks for IO hermetics by comparing the count of multiple outputs in a "
...
public record HermeticByExpectedOutputCountInRangeConfiguration
{
    ...
    [
        ...
        Description(
            "The expected minimum count of the items in the given output names in the given session"
        )
    ]
    ...
    [
        ...
        Range(0, int.MaxValue),
        Description(
            "The expected maximum count of the items in the given output names in the given session"
        )
    ]
