...
public class HermeticByInputOutputPercentage
    : BaseAssertion<HermeticByInputOutputPercentageConfiguration>
{
    /// <inheritdoc />
    ...
    )
    {
        ...
        return outputCount
            == (int)
                Math.Round(
                    inputCount * (Configuration.ExpectedPercentage!.Value / 100),
                    Configuration.MidpointRounding
                );
    }
}
