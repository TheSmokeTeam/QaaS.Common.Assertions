...
public class OutputValidationTests
{
    ...
    public void TestCheckIsOutputValid_ChecksIfOutputIsValidAccordingToMappingAndExpectedResults_AssertValid(
        JsonNode output,
        Dictionary<string, object> expectedResult,
        Dictionary<string, FieldConfiguration> fieldsMapping,
        bool isValid,
        List<string> expectedColumnsNotFound
    )
    {
        // Arrange
        var assertion = new OutputContentByExpectedCsvResults()
        {
            Configuration = new OutputContentByExpectedResultsAsCsvConfiguration()
            {
                ...
                ColumnNameToFieldPathMap = fieldsMapping,
            },
        };
        ...
        var validationResult = ReflectionUtils<OutputContentByExpectedResultsAsCsvConfiguration>
            .GetMethodInfo("CheckIsOutputValid")
    ...
    private static IEnumerable<TestCaseData> _resultsAndMappingWherePathNotExist = new[]
    {
        new TestCaseData(
            ...
            false,
            "Field not found for JSONPath given: $.city"
        ...
        new TestCaseData(
            ...
            InvalidMapping,
            false,
            "Field not found for JSONPath given: $.country"
        ).SetName("PathProvidedInMappingButDontExistInJson"),
    };

    [Test, TestCaseSource(nameof(_resultsAndMappingWherePathNotExist))]
    public void TestCheckIsOutputValid_ChecksIfOutputIsValidAccordingToMappingAndExpectedResults_ThrowsExceptionCausePathNotExists(
        JsonNode output,
        Dictionary<string, object> expectedResult,
        Dictionary<string, FieldConfiguration> fieldsMapping,
        bool isValid,
