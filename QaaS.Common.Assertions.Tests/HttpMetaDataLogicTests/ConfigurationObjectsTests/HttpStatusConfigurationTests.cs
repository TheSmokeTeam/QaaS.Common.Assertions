...
public class HttpStatusConfigurationTests
{
    ...
    public void TestValidateConfiguration_ConfigurationContainsHttpStatus_ShouldBeValidOrNotAccordingToIsValidParameter(
        int httpStatusCode,
        bool isValid,
        int expectedNumberOfValidationResults
    )
    {
        // Arrange
