...
public class HttpStatusTests
{
        ...
        )
        {
            ...
            for (var outputNumber = 0; outputNumber < numberOfOutputs; outputNumber++)
            {
                outputs.Add(
                    ...
                    {
                        MetaData = new MetaData { Http = new Http { StatusCode = statusCode } },
                    }
                );
            }
    ...
    )
    {
            ...
            for (var outputNumber = 0; outputNumber < numberOfOutputs; outputNumber++)
            {
                outputs.Add(
                    new DetailedData<object>
                    {
                        ...
                        {
                            Http = new Http { StatusCode = incorrectStatusCode },
                        },
                    }
                );
            }
        ...
        StringAssert.Contains(
            (numberOfOutputs * numberOfOutputSources).ToString(),
    ...
    public void TestAssertSingleSession_CallAssertFunctionWithNoItems_ShouldReturnTrue()
    {
        ...
        var session = new SessionData
        {
            ...
            Outputs = new List<CommunicationData<object>>
            {
                new() { Name = outputName, Data = new List<DetailedData<object>>() },
            },
        };
        var assertion = new HttpStatus
        {
